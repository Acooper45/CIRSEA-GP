...
matplot(bvec,t(fStarOpt),col="black",type="l",lwd=2,xlab="B/BMSY",ylab="Optimal Fishing Effort Quota")
mtext("a) Optimal Fishing Effort Quota in B/BMSY Space",line=1)
...
matplot(bvec,t(fOpt),col="black",type="l",lwd=2,xlab="B/BMSY",ylab="Actual Fishing Effort Response")
mtext("c) Actual Fishing Effort Response in B/BMSY Space",line=1)
...
mtext(paste("a) Industry NPV, Arhcetype",aRun), line=1)
